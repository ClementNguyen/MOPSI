...
path1=r"C:\\Users\Wissam\Desktop\IMI\MOPSI\\" #folder containing the .csv file
path2=r"C:\Users\Wissam\Desktop\IMI\MOPSI\Images\\" #folder that will store the images
...
def product_distance(product1,product2):
  img_url1=dsc_image_urls[product1]
  img_url2=dsc_image_urls[product2]
  img_filename1=product_names[product1].replace('"', '')
  img_filename2=product_names[product2].replace('"', '')
...
def five_most_similar_products(product):
  ...
  for i in range(len(product_names)):
    print(i)
    if str(dsc_image_urls[i])=='nan' or i==product:
      distance.append((999999999999999,i)) 
    else:
      distances.append((coeffw*product_distance(product,i)+coeffc*similarity_test.evaluateSimilarity(product,i),i))
  list=[]
  for i in range(5):
    list.append(distances[i][1],dsc_image_urls[i])
  return list
...
def main(_):
  ...
  # else:
  #   d=coeffw*product_distance(product1,product2)+coeffc*similarity_test.evaluateSimilarity(product1,product2)
  #   print('The distance between ',product_names[product1], ' and ',product_names[product2],' is : ',d)
